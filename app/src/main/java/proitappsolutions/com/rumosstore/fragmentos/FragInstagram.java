...
public class FragInstagram extends Fragment {

    private LinearLayout progressBar;
    RingProgressBar anelprogressbar;

    public FragInstagram(){}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_instagram, container, false);
        ...
        webView.loadUrl("https://www.instagram.com/jornalvanguardaa/");
        webView.setWebViewClient(new WebViewClient(){
            @Override
