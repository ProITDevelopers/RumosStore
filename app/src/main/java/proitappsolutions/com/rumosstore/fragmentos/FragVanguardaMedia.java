...
public class FragVanguardaMedia extends Fragment {
    ...
    public FragVanguardaMedia() {
        // Required empty public constructor
    }


    public static FragVanguardaMedia newInstance(String param1, String param2) {
        FragVanguardaMedia fragment = new FragVanguardaMedia();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_vanguarda_media, container, false);
    }
    ...
    private void carregarWebView(View view){
        webView = (WebView) view.findViewById(R.id.webViewVanguarda);
        ...
        anelprogressbar = (RingProgressBar) view.findViewById(R.id.progressbar_2);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://vanguarda.co.ao/multimedia/video");
