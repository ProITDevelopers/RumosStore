...
public class KiosqueAdapter extends BaseAdapter {

    private List<Kiosque> movieList;
    private Context mContext;

    public KiosqueAdapter(List<Kiosque> movieList, Context mContext) {
