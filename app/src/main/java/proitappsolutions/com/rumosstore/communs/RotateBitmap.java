...
public class RotateBitmap {
    ...
    private Bitmap rotateImageIfRequired(Bitmap img, Uri selectedImage) throws IOException {
        ...
        android.support.media.ExifInterface ei;
        try {
            ei = new android.support.media.ExifInterface(input);

            int orientation = ei.getAttributeInt(android.support.media.ExifInterface.TAG_ORIENTATION, android.support.media.ExifInterface.ORIENTATION_NORMAL);
